...
<div class="signup__container" style="
height: 850px;
">
    <div class="container_child signup_thumbnail">
      <div class="thumbnail__logo">
        <img width="210" src="images\logo\logo.png" alt="#"  style="position: relative; top: -114px; right: -1px; width:245px" />
      </div>
     ...
     position: relative;
     top: 243px;
     right: 8px;">Êtes-vous prêt à nous joindre?</h2>
     ...
     font-size: revert;">——Your movies to watch——</h2>
      ...
      <div class="signup__overlay" style= filter: blur(2px)></div>
    </div>
    <div class="container_child signup_form" style="    width: 50%;
    height: 775px;
    color: #fff">
      ...
      <form action="#">
        <div class="form-group" style="position: relative; top: 4px">
          ...
          <input class="form-control" type="text" name="username"  placeholder="Votre Nom " style="position: relative; top: 23px; left: -39px"required />
        </div>

        <div class="form-group" style="position: relative; top: 43px">
          <label for="username" style="position: relative;
          top: 4px;">Prénom</label>
          <input class="form-control" type="text" name="username" id="username" placeholder="Votre Prénom " style="position: relative; top: 30px; left: -62px"required />
        </div>

        <div class="form-group" style="position: relative; top: 91px">
        ...
        <div class="form-group" style="position: relative; top: 129px ">
        ...
        <div class="form-group" style="position: relative; top: 143px ">
          <label for="Date" style="position: relative; top: 50px">Date de Naissance</label>
          <input class="form-control" type="Date" name="Date" id="Date de Naissance" placeholder="jj/mm/aaaa"  style="position: relative; top: 76px; left: -134px" required />
        </div>
        <div class="form-group" style="position: relative; top: 165px ">
     <label class="label_field"  style="position: relative; top: 81px">Sexe</label>
     <select  name="sexe"  style="position: relative; top: 104px; left: -35px">
     <option value="H">Homme</option>
     <option value="F">Femme</option>
      <option value="G">Autre</option>
     </select>
    </div>
          <div class="form-group" style="position: relative; top: 275px ">
  ...
  <option value="AUC">Aucun</option>
        ...
        <div class="form-group" style="position: relative; top: 306px ">
  ...
  <option value="ZWE">Zimbabwe</option>
          ...
          <div class="form-group" style="position: relative; top: 345px ">
    ...
    <input class="form-control" required="required" name="ville" placeholder=" Votre ville" style="position: relative; top: 50px; left: -40px" />
     ...
     <div class="form-group" style="position: relative; top: 395px ">
     <label class="label_field" style="position: relative; top: 25px">Numéro de Téléphone</label>
   <input class="form-control" id="phone" required="required" name="phone" placeholder="Exemple : 0612345678" type="tel" style="position: relative; top: 61px; left: -164px"> 
  </div>
       
        <div class="m-t-lg">
          <ul class="list-inline">
            <li style="position: relative; bottom: -470px; left: 56px">
              <input class="btn btn--form" type="submit" value="Inscrire" />
            </li>
            <li style="position: relative; top:490px; left: 50px">
              <a class="signup__link" href="-------------">Vous avez dèja un compte?</a>
            </li>
          </ul>
        </div>
      </form>  
